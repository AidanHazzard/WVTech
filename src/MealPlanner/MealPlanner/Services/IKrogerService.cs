...
public interface IKrogerService
{
    ...
    Task<List<KrogerStoreInfo>> FindNearestStoresAsync(string zipCode, int limit = 5);
    Task<KrogerProductMatch?> SearchProductUpcAsync(string ingredientName, string storeId, float amount, string measurement);
